...
(deftest java-interface-test
  (testing "Satandard date string parse testing"
    (let [^Timewords timewords-parser (Timewords.)]
      ...
      (is (= (date 2013 1 24 8 46 54) (.parse timewords-parser "2013-01-24T08:46:54Z" nil "en")))
      (is (= (date 2013 1 24 8 46 54) (.parse timewords-parser "2013-01-24T08:46:54Z" (Date.) "en"))))))

...
(deftest core-test
  ...
  (testing "Standard date parsing"
    ...
    ;;; to fix
    (is (= (date 1865 04 27 0 0 0) (parse "1865-04-27T00:00:00-05:00")))
    (is (= (date 2009 1 8) (parse "2009/01/08")))
    (is (= (date 2013 3 12) (parse "2013-03-12")))
    (is (= (date 2010 8) (parse "August 2010")))
    (is (= (date 2013) (parse "2013")))
    (is (= (date 2010  7  1 0  0  0) (parse "1st July 2010")))
    (is (= (date 2010  7  2 0  0  0) (parse "2nd July 2010")))
    (is (= (date 2010  7  3 0  0  0) (parse "3rd July 2010")))
    ...
    (is (= (date 2017  1  2 0  0  0) (parse "Monday, 2nd January 2017")))
    (is (= (date 2017  1  3 0  0  0) (parse "Tuesday, 3rd January 2017")))
    (is (= (date 2017  1  8 0  0  0) (parse "Sunday, 8th January 2017"))))

  (testing "EN date parsing"
    (is (= (date 2015 10 19) (parse "Monday October 19, 2015")))
    (is (= (date 2015 10 19) (parse "Monday Oct 19, 2015")))
    (is (= (date 2015 10 19) (parse "Mon Oct 19, 2015")))
    (is (= (date 2015 10 19 5 44) (parse "Mon Oct 19, 2015 5:44am")))
    (is (= (date 2015 10 19 17 44) (parse "Mon Oct 19, 2015 5:44pm")))
    (is (= (date 2015 10 19 5 44) (parse "Mon Oct 19, 2015 5:44am PST")))
    ...
    (is (= (date 2015 10 19 13 30) (parse "Monday 19 October 2015 13.30 BST")))
    ...
    (is (= (date 2012 12 9 9 54 7) (parse "12/09/2012 09:54:07 AM PST")))
    ...
    (is (= (date 2013 1 16 8 11 37) (parse "2013-01-16 08:11:37 EST")))
    ...
    (is (= (date 2015 11 16 15 13) (parse "Nov 16, 2015 3:13 p.m.")))
    (is (= (date 2015 11 13) (parse "13 Nov 2015")))
    ;(is (= (date 2015 11 16) (parse "Houston (Platts)--16 Nov 2015 517 pm EST/2217 GMT")))
    (is (= (date 2015 11 14 0 0) (parse "2015-11-14T00:00:00-05:00")))
    (is (= (date 2015 11 17 5 17) (parse "2015-11-17T05:17:00-05:00")))

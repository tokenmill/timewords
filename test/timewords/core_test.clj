...
(deftest core-test
  ...
  (testing "EN date parsing"
    ...
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/seconds 1))) (tc/to-long (parse "a sec ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/seconds 1))) (tc/to-long (parse "1 sec ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/seconds 1))) (tc/to-long (parse "1 second ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/seconds 16))) (tc/to-long (parse "16 secs ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/seconds 16))) (tc/to-long (parse "16 seconds ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/seconds 16))) (tc/to-long (parse "16s ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/minutes 1))) (tc/to-long (parse "a min ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/minutes 1))) (tc/to-long (parse "1 min ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/minutes 32))) (tc/to-long (parse "32 mins ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/minutes 1))) (tc/to-long (parse "a minute ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/minutes 1))) (tc/to-long (parse "1 minute ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/minutes 32))) (tc/to-long (parse "32m ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/minutes 32))) (tc/to-long (parse "32 minutes ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/hours 1))) (tc/to-long (parse "a hour ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/hours 1))) (tc/to-long (parse "an hour ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/hours 1))) (tc/to-long (parse "1h ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/hours 1))) (tc/to-long (parse "1 hour ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/hours 2))) (tc/to-long (parse "2 hours ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/days 1))) (tc/to-long (parse "a day ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/days 1))) (tc/to-long (parse "1d ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/days 1))) (tc/to-long (parse "1 day ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/days 2))) (tc/to-long (parse "2 days ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/months 1))) (tc/to-long (parse "a month ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/months 1))) (tc/to-long (parse "1 month ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/months 2))) (tc/to-long (parse "2 months ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/years 1))) (tc/to-long (parse "a year ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/years 1))) (tc/to-long (parse "1 year ago")))))
    (is (> 1000 (- (tc/to-long (joda/minus (joda/now) (joda/years 2))) (tc/to-long (parse "2 years ago")))))

...
(deftest core-test
  ...
  (testing "EN date parsing"
    ...
    (let [delta 1000]
      ...
      (is (> delta (- (tc/to-long (joda/minus (joda/now) (joda/millis 16000))) (tc/to-long (parse "16s ago")))))
      ...
      (is (> delta (- (tc/to-long (joda/minus (joda/now) (joda/months 1))) (tc/to-long (parse "last month")))))
      ...
      (is (> delta (- (tc/to-long (joda/plus (joda/now) (joda/millis 16000))) (tc/to-long (parse "16s from now")))))

...
(deftest fr-dates-test
  (testing "French month names and common French formats"
    ...
    (is (= (date 2018 5 8 23 01) (parse "le 8 mai à 23h01" (.toDate (joda/date-time 2018)) "fr")))
    ...
    (is (= (date 2018 5 8 22 29) (parse "Le 08/05 à 22:29" (.toDate (joda/date-time 2018)) "fr")))
